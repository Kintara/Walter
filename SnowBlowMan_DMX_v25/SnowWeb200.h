...
<tr>
<td>
     <button class="button2" style="width:100%; height:100%;" >SNOW BLOWMAN CONTROL</button> </td>
     </tr>
     </table>
<hr>
<table width ="100%">
...
<input type="range" class="slider"  min="0" max="45" value = "30" step="10" id="durationlSlider" oninput="UPDATE_DURATIONSLIDER(this.value)">   </td>
<br>
<hr>
<br>
<table width ="100%">
<tr>
<td style="width:50%">
     <button class="button2" style="width:100%; height:100%;">Blow %</button> </td>
<td style="width:25%">
...
<input type="range" class="slider" id="airSlider"  min="1" max="101" value = "26"  step="25" oninput="UPDATE_AIRSLIDER(this.value)"> 
<br>
<hr>
<br>
<table width ="100%">
<tr>
<td style="width:50%">
     <button class="button2" style="width:100%; height:100%;">Flow %</button> </td>
<td style="width:25%" !importent>
...
<td style="width:25%">
 ...
 <input type="range" class="slider"   id="flowSlider" min="0" max="10" value = "1" step="1" oninput="UPDATE_FLOWSLIDER(this.value)">
